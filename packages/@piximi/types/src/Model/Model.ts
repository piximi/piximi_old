...
export type CompileOptions = {
  losses: LossOrMetricFn | Array<LossOrMetricFn> | { [outputName: string]: LossOrMetricFn };
  metrics: LossOrMetricFn | Array<LossOrMetricFn> | { [outputName: string]: LossOrMetricFn };
