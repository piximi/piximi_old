...
var EvaluateClassifierDialog_1 = require("../../../EvaluateClassifierDialog/EvaluateClassifierDialog");
exports.EvaluateListItem = function(probs) {
  var datasetInitialized = probs.datasetInitialized,
    setDatasetInitialized = probs.setDatasetInitialized;
  ...
  return (
    ...
    React.createElement(
      ...
      React.createElement(
        core_1.ListItem,
        {button: true, dense: true, onClick: evaluate},
        "// @ts-ignore",
        React.createElement(
          core_1.ListItemIcon,
          null,
        ...
        React.createElement(core_1.ListItemText, {
          primary: translation("Evaluate")
        })
      ),
      React.createElement(
        EvaluateClassifierDialog_1.ConnectedEvaluateClassifierDialog,
        {
